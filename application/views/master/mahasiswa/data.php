<div class="box">
    ...
    <div class="box-body">
        <div class="mt-2 mb-3">
            <a href="<?= base_url('mahasiswa/add') ?>" class="btn btn-sm btn-flat bg-blue"><i class="fa fa-plus"></i> Agregar</a>
            <a href="<?= base_url('mahasiswa/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Importar</a>
