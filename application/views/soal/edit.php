                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="dosen_id" class="control-label">Profesor (Curso)</label>
                            ...
                            <div class="col-sm-12">
                                <label for="soal" class="control-label text-center">Preguntas</label>
                                <div class="row">
                            ...
                            ?>
                                ...
                                <div class="col-sm-12">
                                    <label for="jawaban_<?= $abj; ?>" class="control-label text-center">Respuesta <?= $ABJ; ?></label>
                                    <div class="row">
                                        <div class="form-group col-sm-3">
