        ...
        <div class="col-sm-4">
            ...
            <div class="box box-success">
                ...
                <div class="box-footer">
                    <button type="submit" id="btn-info" class="btn btn-success">Guardar</button>
                </div>
            </div>
            <?= form_close() ?>
        </div>
    ...
    <?php if ($user->id !== $users->id) : ?>
        <div class="col-sm-4">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <button type="submit" id="btn-level" class="btn btn-success">Guardar</button>
                </div>
            </div>
            <?= form_close() ?>
            ...
            <div class="box box-success">
                ...
                <div class="box-body pb-0">
                    <div class="form-group">
                        <label>
                            <input <?= $users->active === '1' ? "checked" : "" ?> type="radio" name="status" value="1"> Activo
                        </label>
                        <label>
                            <input <?= $users->active === '0' ? "checked" : "" ?> type="radio" name="status" value="0"> Inactivo
                        </label>
                        <small class="help-block"></small>
                    </div>
                </div>
                <div class="box-footer">
                    <button type="submit" id="btn-status" class="btn btn-success">Guardar</button>
                </div>
            </div>
            <?= form_close() ?>
        </div>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body pb-0">
                    <div class="form-group">
                        ...
                        <input type="password" placeholder="Contraseña Actual" name="old" class="form-control">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                        <label for="new">Nueva Contraseña</label>
                        <input type="password" placeholder="Nueva Contraseña" name="new" class="form-control">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                        <label for="new_confirm">Confirmación Contraseña</label>
                        <input type="password" placeholder="Confirmación de Contraseña" name="new_confirm" class="form-control">
                        <small class="help-block"></small>
                    </div>
                </div>
                <div class="box-footer">
                    <button type="reset" class="btn btn-flat btn-danger">
                        <i class="fa fa-rotate-left"></i> Resetear Valores
                    </button>
                    <button type="submit" id="btn-pass" class="btn btn-flat btn-primary">Cambiar Contraseña</button>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('form#change_password').on('submit', function(e) {
                ...
                data = $(this).serialize();
                msg = "Tu contraseña cambió correctamente.";
